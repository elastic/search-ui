...
| `a11yNotifications`         | Boolean                                                                 | optional  | false   | Search UI will create a screen reader accessible live region to announce search results & other actions. This will be turned on by default in our 2.0 release.                                                               |
