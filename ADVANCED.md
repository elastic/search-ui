...
| `setSort`           | `sortField` String - field to sort on<br/>`sortDirection` String - "asc" or "desc"<br/>`sortList` Array - [{sortField: sortDirection}]                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |        |                                                                                                                                           |
...
| `sortList`                                        | Array[[SortList](./packages/react-search-ui/src/types/SortList.js)]| optional  | List of field and directions to sort on               |
