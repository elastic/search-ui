...
| `a11yNotifications`         | Boolean                                                                 | optional  | true    | By default, Search UI creates a screen reader accessible live region to announce search results & other actions. To turn this off (which we only recommend doing if rolling your own accessibility solution), pass `false`.  |
