...
1. Make the facet "disjunctive" by adding it to the `disjunctiveFacets` list config. This will ensure that the facet displays all
...
2. Make the `Facet` component user the `filterType` of `any`.
