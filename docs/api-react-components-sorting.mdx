...
| sortOptions |                                                                                                                                                                       |
| view        | Used to override the default view for this Component. See <DocLink id="api-react-components-sorting" section="view-customization" text="View customization" /> below. |
