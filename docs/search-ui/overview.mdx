...
<DocLink
  id="advanced"
  section="connectors-and-handlers"
  text="Connectors and Handlers Guide"
/> to learn more, or check out the [Elasticsearch Example](https://github.com/elastic/search-ui/tree/master/examples/elasticsearch).
