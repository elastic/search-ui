...
The <DocLink id="advanced" text="Advanced guide" /> contains several useful guides. 😎
...
Read the <DocLink id="advanced" section="custom-styles-and-layout" text="Custom Styles and Layout Guide" /> to learn more, or check out the [Seattle Indies Expo Demo](https://github.com/elastic/seattle-indies-expo-search).

### Can I build my own Components?

Yes! Absolutely.

Check out the <DocLink id="advanced" section="build-your-own-component" text="Build Your Own Component Guide" />.
...
Read the <DocLink id="advanced" section="connectors-and-handlers" text="Connectors and Handlers Guide" />.
...
<DocLink id="advanced" section="connectors-and-handlers" text="Connectors and Handlers Guide" /> to learn more, or check out the
[Elasticsearch Example](https://github.com/elastic/search-ui/tree/master/examples/elasticsearch).
