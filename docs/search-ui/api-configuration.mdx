...
| field                       | description                                                    |
| --------------------------- | -------------------------------------------------------------- |
| `alwaysSearchOnInitialLoad` | Boolean. Optional. Executes a search query when the page loads |
| `hasA11yNotifications`      | Boolean. Optional. Enables a11y notifications                  |
| `a11yNotificationMessages`  | Object. Optional. Customizes a11y notifications                |
