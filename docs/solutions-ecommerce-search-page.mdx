...
First thing you want to consider before implementing your search is the backend you're going to use for your data. In the E-commerce use-case Search UI works best with **Elastic App Search** and **Elasticsearch**.
...
Elasticsearch connector gives you full control over the request body, so you can use any features Elasticsearch has to offer.

Read our <DocLink id="api-connectors-elasticsearch" text="Elasticsearch connector guide" /> and the section about <DocLink id="api-connectors-elasticsearch" section="customise-the-elasticsearch-request-body" text="request body customization" />.
