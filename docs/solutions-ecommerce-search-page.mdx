...
Elasticsearch doesn't have administrative dashboards where you can tweak relevance. If that is important to you - consider using the App Search connector.

On the other hand, Elasticsearch connector gives you full control over the request body, so you can use any features Elasticsearch has to offer, if you know the API.
