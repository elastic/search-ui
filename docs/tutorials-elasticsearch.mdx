...
For more information on configuration, visit the <DocLink slug="/search-ui/api/core/configuration" text="API configuration docs" />.
...
Next you can add more data into the index, <DocLink slug="/search-ui/api/react/components/result" section="view-customization" text="update the results view to display more fields" />, and deploy the app.
