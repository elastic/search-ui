...
```shell
curl https://codeload.github.com/elastic/app-search-reference-ui-react/tar.gz/main | tar -xz
```
...
![copy es endpoint](images/elasticsearch-tutorial/copy-cloud-id.jpg)
...
For more information on configuration, visit the <DocLink id="api-core-configuration" text="API configuration docs" />.
...
Next you can add more data into the index, <DocLink id="api-react-components-result" section="view-customization" text="update the results view to display more fields" />, and deploy the app.
