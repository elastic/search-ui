...
In ecommerce, to build great search experiences for your customers, you need to focus on three major experiences:

![](images/ecommerce/overview/overview.png)
...
- **Product Listing Page**: To show a list of products that match your customers’ needs in a particular category. Offer rich filtering and navigation options to refine the products.
...
<DocRelatedArticles
  ...
  items={[
    ...
    {
      pageId: "solutions-ecommerce-product-listing-page"
    },
    {
