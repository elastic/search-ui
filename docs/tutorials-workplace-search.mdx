...
title: Search UI with Workplace Search
date: 2022-04-18
tags: ["demo"]
---
...
We'll use React components in this tutorial, but you can use Search UI with any UI framework and even vanilla JavaScript. Read about our <DocLink slug="/search-ui/api/architecture" /> to learn more about using Search UI outside of React.
