...
Carousels can be used to show groups of products into a row. Typically used to show products within a certain category or tag, like "most popular", "best rated" and "on sale".
