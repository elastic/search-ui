...
| view                    | Used to override the default view for this Component. See <DocLink id="api-react-components-results" section="view-customization" text="View customization" /> below. |
...
A separate guide specifically for customizing the Result component can be found <DocLink id="api-react-components-result" section="view-customization" text="here." />, which can be used for providing a `resultView` prop.
