---
id: guides-building-a-custom-connector
slug: /search-ui/guides/building-a-custom-connector
...
See <DocLink id="api-core-state" section="request-state" text="Request State"/>, <DocLink id="api-core-state" section="response-state" text="Response State"/> and <DocLink id="api-core-configuration" section="search-query-queryconfig" text="Search Query Config"/> for more information.
