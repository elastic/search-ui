...
| autocompleteView              | Used to override only the autocomplete dropdown. See <DocLink id="api-react-components-search-box" section="autocomplete-view-customization" text="Autocomplete view customization" /> below.                                                                                                                                                                |
| inputView                     | Used to override only the input box. See <DocLink id="api-react-components-search-box" section="input-view-customization" text="Input view customization" /> below.                                                                                                                                                                                          |
| view                          | Used to override the default view for this Component. See <DocLink id="api-react-components-search-box" section="full-view-customization" text="Full view customization" /> below.                                                                                                                                                                           |
...
| autocompleteView              | Component to use for Autocomplete. When rendering, pass all props documented below in the <DocLink id="api-react-components-search-box" section="autocomplete-view-customization" text="Autocomplete view customization" /> section.<br /> Note that this can be challenging to do since some of the required props are generated by Downshift. It's generally advised not to try to use this property directly when creating a custom view. |
