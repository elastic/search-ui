...
| `autocompleteQuery`         | <DocLink slug="/search-ui/api/core/configuration" section="autocomplete-query" text="Autocomplete Query Config" /> | Configuration options for the autocomplete query.                                                                                                                                                                           |
...
| `searchQuery`               | <DocLink slug="/search-ui/api/core/configuration" section="autocomplete-query" text="Search Query Config" />       | Configuration options for the main search query.                                                                                                                                                                            |
...
The "Context" is a flattened object containing, as keys, all <DocLink slug="/search-ui/api/core/state" text="State" /> and <DocLink slug="/search-ui/api/core/actions" text="Actions" />.
...
See <DocLink slug="/search-ui/api/core/state" section="RequestState" text="Request State" /> for more properties that can be set in initial state.
