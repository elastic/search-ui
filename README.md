...
[Read the Headless Core Guide](./ADVANCED.md#headless-core) for more information, or check
out the [Vue.js Example](https://github.com/yakhinvadim/vue-search-ui-demo).

### Can I use my own styles?

You can!

Read the [Custom Styles and Layout Guide](./ADVANCED.md#custom-styles-and-layout) to learn more, or check out the [Seattle Indies Expo Demo](https://github.com/constancecchen/seattle-indies-expo-search).
